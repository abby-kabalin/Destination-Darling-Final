...
urlpatterns = [
    ...
    path("<str:pk>/",
         AttractionDetailView.as_view(), name="attraction_detail"),
    path("<str:pk>/edit/",
         AttractionUpdateView.as_view(), name="attraction_edit"),
    path("<str:pk>/delete/",
         AttractionDeleteView.as_view(), name="attraction_delete"),
