...
class DestinationTests(TestCase):
    ...
    def setUpTestData(cls):
        cls.user = get_user_model().objects.create_user(username="testuser", email="test@email.com", password="secret", country="Test Country")
    ...
    def test_destination_updateview(self):
        ...
        self.assertEqual(Destination.objects.last().details, "Updated details about new location")
...
class DestinationCommentTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.newdestination = Destination.objects.create(
            location="TestLocation",
            details="This is a test location",
            country="Tester Country",
            author=cls.user,
        ...
        cls.destinationcomment = DestinationComment.objects.create(
            destination=cls.newdestination.pk,
